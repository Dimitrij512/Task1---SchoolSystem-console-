		...
		while (true) {
			...
			if (role == STUDENT_ROLE) {
				...
				while (start) {
					...
					System.out.println("Show your subject and raiting press : 2 ");
					System.out.println("--------------------");
					int parametr = Integer.parseInt(st.enterNumber());
					if (parametr == 1) {
						st.showAllSchedule();
					} else if (parametr == 2) {
						st.showRaiting(Db.currentSession.getStudent());
					}
			...
			if (role == DIRECTOR_ROLE) {
				...
				while (start) {
					...
					System.out.println("delete educator : 5");
					System.out.println("add educator : 6");
					System.out.println("add student : 7");
					System.out.println("--------------------");
					parametr = Integer.parseInt(sd.enterNumber());
					if (parametr == 2) {
					...
					System.out.println("If you want yet press : 1");
					System.out.println("If you log out press press : other key  ");
					parametr = Integer.parseInt(sd.enterNumber());
					if (parametr != 1) {
						start = false;
					}
